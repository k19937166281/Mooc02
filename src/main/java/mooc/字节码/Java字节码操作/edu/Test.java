...
import mooc.字节码.Java字节码操作.Greeting;
...
public class Test {
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException, ClassNotFoundException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		Method newMethod = Class.forName("mooc.字节码.Java字节码操作.AsmGreeting").getMethod("hello");
		newMethod.invoke(null);//mooc/字节码/Java字节码操作/Greeting.java
