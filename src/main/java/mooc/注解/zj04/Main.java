...
public class Main {
    public static void main(String[] a) throws Exception {
        ...
        //注解不会保存到class文件中
        Class a1 = Class.forName("mooc.注解.zj04.A1");
        Class a2 = Class.forName("mooc.注解.zj04.A2");
        ...
        Class b1 = Class.forName("mooc.注解.zj04.B1");
        Class b2 = Class.forName("mooc.注解.zj04.B2");
        ...
        Class c1 = Class.forName("mooc.注解.zj04.C1");
        Class c2 = Class.forName("mooc.注解.zj04.C2");
